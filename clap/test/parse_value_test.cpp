...
struct ParseSignedIntegralTest : public ::testing::Test {
  ...
  inline static const auto negative_ = TestCase{"-1234", static_cast<T>(-1234)};
  inline static const auto positive_ = TestCase{"1234", static_cast<T>(1234)};
...
struct ParseCharErrorsTest : public ::testing::Test,
                             public ::testing::WithParamInterface<std::string> {
};
